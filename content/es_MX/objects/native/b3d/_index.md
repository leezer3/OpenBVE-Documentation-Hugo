...
- [2. Sintaxis](#syntax)
- [3. Comandos disponbiles](#commands)
...
## <a name="commands"></a>■ 3. Comandos disponbles
...
{{% command-arguments %}}
***v<sub>i</sub>***: Corresponde al indice del vértice para incluir en esta cara. Los valores permitidos son 0 hasta *n*-1, donde *n* es el numero de comandos de vertices usados.  
{{% /command-arguments %}}
...
El número de vértices *lados* por lo general entre 6 o 8 puede satisfacer cuando un radio pequeño es usado, por ejemplo para crear un poste. Sin importar los valores de *RadioSuperior*,*RadioInferior* y *lados*, el tronco siempre tendrá 2**n* vértices, y usualmente *n*+2 caras a menos que cualquiera de los topes o tapas sean omitidas. Si el *RadioSuperior* o el *RadioInferior*  son negativos, el valor absoluto será tomado, pero las tapas no serán creadas. Si la *Altura* es negativa, los roles de arriba y abajo serán invertidos y las caras serán visibles desde adentro, mientras que de otra manera, serán visibles desde afuera.
...
En openBVE 2, sólo brillo aditivo será soportado y el *ModoAtenuaciónBrillo* parámetros es posible que quede en obsoleto. Por favor evite usar combinado en modo normal en conjunto con brillo.
