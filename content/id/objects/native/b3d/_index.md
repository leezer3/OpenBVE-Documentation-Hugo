...
Anda bisa menambahkan komentar di mana saja pada akhir baris. Komentar ditambahkan dengan menulis karakter titik koma (U+003B) ( ; ) di depannya. Jika sistem menemukan karakter ini, semua karakter di belakangnya diabaikan dan tidak dianggap sebagai perintah.
...
Perintah ini mengatur warna untuk semua Face yang sudah dibuat di [Meshbuilder] terakhir. Jika tidak ada gambar yang dipakai sebagai tekstur, maka sistem akan menghasilkan warna yang dihasilkan dari kombinasi *Red*, *Green*, dan *Blue* . Jika ada teksturnya, maka keseluruhan gambar akan ditimpa dengan warna yang sudah ditulis di perintah ini, misalnya jika gambar ditimpa dengan warna hitam akan menghasilkan warna hitam, dan jika ditimpa dengan warna putih maka akan menghasilkan gambar itu sendiri. Jika ditimpa dengan warna antara hitam dan putih akan membuat setiap pixel dalam gambar lebih gelap. Jika pada rute ada skrip pencahayaan, maka hasil akhir warnanya dapat berubah, tapi biasanya yang akan terjadi adalah warnanya menjadi lebih gelap.
...
Perintah ini membuat warna yang memancar untuk semua Face yang sudah dibuat di [Meshbuilder] terakhir. Pada perintah Color, warna berpengaruh terhadap efek cahaya dari rute, sedangkan EmissiceColor tidak. Biasanya EmmisiveColor dipakai untuk mesh yang dapat memancarkan cahaya sendiri, seperti lampu, persinyalan, jendela, dan sebagainya. 
