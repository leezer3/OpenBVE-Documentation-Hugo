...
| ElapseData | AIData (class): | The data passed to the plugin. |
| ---------- | ---- | ------------------------------ |
|            |      |                                |
...
| int  | ConstSpeed | Gets or sets whether the const speed system is enabled.                           |
| bool | The meanings of the notches are explained in the sections on SetReverser, SetPower and SetBrake. | AIResponse (enumeration): |
...
| SignalData[] | AIData (class): | The signal data per section. |
| ------------ | ---- | ---------------------------- |
|              |      |                              |
...
| BeaconData | AIData (class): | The beacon data. |
| ---------- | ---- | ---------------- |
|            |      |                  |
...
| AIData | AIData (class): | The AI data. |
| ------ | ---- | ------------ |
|        |      |              |
...
| ---------- | -------- | -------------------------------- |
| {{% /table-nonheader %}} | Response | {{% table-nonheader %}}    |
