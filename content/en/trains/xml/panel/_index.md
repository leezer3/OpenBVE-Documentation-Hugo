---
title: "The **panel.xml** file format"
linktitle: "The panel.xml file"
weight: 1
---
...
The **panel.xml** format is the native train panel format for newer versions of OpenBVE.

It allows for the creation of touch sensitive zones, and the assignation multiple switchable screens, and is conceptually very similar to the **Panel2.cfg** format.
...
## <a name="this"></a>■ 3. The This Node

The **\<This>** node defines the base panel texture.
...
{{% command %}}  
**\<DaytimeImage>** *FileName*  **\<DaytimeImage>**
{{% /command %}}
...
{{% command %}}  
**\<NightTimeImage>** *FileName*  **\<</NightTimeImage>
{{% /command %}}
...
{{% command %}}  
**\<TransparentColor>** *HexColor*  **\</TransparentColor>**
{{% /command %}}
...
## <a name="pilotlamp"></a>■ 4. The PilotLamp node

The **\<PilotLamp>** node creates an indicator that can be made visible or invisible. You can use as many of these sections as required.

The *DaytimeImage* is required to be specified if you make use of the PilotLamp node. The *Subject* used needs to return 1 if the PilotLamp is to be made visible, otherwise it will be invisible.
...
## <a name="needle"></a>■ 5. The Needle node

The Needle node creates a rotating element, or needle. You can use as many of these nodes as required.
...
{{% command %}}  
**\<Location>** *CenterX*, *CenterY*  **\</Location>**
{{% /command %}}
...
{{% command %}}  
**\<InitialAngle>** *ValueInDegrees*  **\</InitialAngle>**
{{% /command %}}
...
{{% command %}}  
**\<LastAngle>** *ValueInDegrees*  **\</LastAngle>**
{{% /command %}}
...
## <a name="digitalnumber"></a>■ 6. The DigitalNumber node

The **\<DigitalNumber>** node creates an indicator that can switch between multiple states, useful to build up a display of decimal digits. You can use as many of these nodes as required.
...
## <a name="digitalgauge"></a>■ 7. The DigitalGauge node

The **\<DigitalGauge>** node creates a solid-color square of which only a radial section is shown at a time. You can use as many of these nodes as required.
...
## <a name="lineargauge"></a>■ 8. The LinearGauge node

The **\<LinearGauge>** node creates a panel layer, which uses texture shifting to create a sliding linear gauge. You can use as many of these nodes as required.
...
{{% command %}}  
**\<Direction>** *XDirection*, *YDirection*  **\</Direction>**
{{% /command %}}
...
## <a name="timetable"></a>■ 9. The Timetable node

The **\<Timetable>** node defines where to place custom timetables. The actual images are loaded via the route file. Only one Timetable section may be used within the file.
...
## <a name="windscreen"></a>■ 10. The Windscreen node

The **\<Windscreen>** node defines a set of animated raindrops / snowflakes and windscreen wipers.
...
{{% command %}}  
**\<NumberOfDrops>** *TotalDrops*  **\</NumberOfDrops>**
{{% /command %}}
...
{{% command %}}  
**\<DaytimeDrops>** *Drops*  **\</DaytimeDrops>**
{{% /command %}}
...
{{% command %}}  
**\<NightTimeDrops>** *Drops*  **\</NightTimeDrops>**
{{% /command %}}
...
{{% command %}}  
**\<DaytimeFlakes>** *Flakes*  **\</DaytimeFlakes>**
{{% /command %}}
...
{{% command %}}  
**\<NightTimeFlakes>** *Flakes*  **\</NightTimeFlakes>**
{{% /command %}}
...
## <a name="screens"></a>■ 12. Changeable Screens

Optionally, nodes other than the **<This>** node my be contained within a **<Screen>** node. The currently visible screen may be changed via touch commands, allowing a group of panel elements to be shown or hidden.

A **<Screen>** node requires the following additonal properties:
...
{{% command-arguments %}}  
***ScreenNumber***: An integer uniquely identifying this screen.
{{% /command-arguments %}}
...
{{% command-arguments %}}  
***ScreenLayer***: The layer of this screen. **NOTE:** This layer is relative to the screens.
{{% /command-arguments %}}

## <a name="touch"></a>■ 12. Touch Zones

The **<Touch>** node creates a zone on the panel, operable by touch, and supports the following properties:
...
{{% command-arguments %}}  
***Left***: A floating-point number representing the x-coordinate at which the left of the touch zone starts. The default value is 0.  
***Top***: A floating-point number representing the y-coordinate at which the top of the touch zone starts. The default value is 0.  
{{% /command-arguments %}}
...
{{% command-arguments %}}  
***X***: A floating-point number representing the X-size in pixels of the touch zone.  
***X***: A floating-point number representing the Y-size in pixels of the touch zone.  
{{% /command-arguments %}}

------

{{% command %}}  
**\<JumpScreen>** *ScreenIndex*  **\</JumpScreen>**
{{% /command %}}

{{% command-arguments %}}  
***ScreenIndex***: An integer, representing the Screen index to display when this zone is touched.  
{{% /command-arguments %}}

------

{{% command %}}  
**\<SoundIndex>** *SoundIndex*  **\</SoundIndex>**
{{% /command %}}

{{% command-arguments %}}  
***SoundIndex***: An integer, representing the Touch sound index to play when this zone is touched.  
{{% /command-arguments %}}
...
{{% command-arguments %}}  
***Command***: The control to operate when this zone is touched.  
{{% /command-arguments %}}
...
{{% command-arguments %}}  
***Option***: An integer, representing the option to be passed to the command.  (For example the power notch)
{{% /command-arguments %}}

------

{{% command %}}  
**\<Cursor>** *FileName*  **\</Cursor>**
{{% /command %}}

{{% command-arguments %}}  
***FileName***: The image file, relative to the train path to be used as the mouse cursor when hovering over this touch zone.
{{% /command-arguments %}}
